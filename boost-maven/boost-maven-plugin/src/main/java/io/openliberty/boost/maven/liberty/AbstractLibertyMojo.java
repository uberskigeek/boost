...
import static io.openliberty.boost.maven.liberty.AbstractLibertyMojo.savedPort;
...
public abstract class AbstractLibertyMojo extends MojoSupport {
    ...
    protected static boolean tempPort = false;

    protected static boolean noBootProps = false;
