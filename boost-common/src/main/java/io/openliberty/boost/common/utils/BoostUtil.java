...
public class BoostUtil {
    ...
    public static String encrypt(String libertyInstallPath, String password, String encryptionType,
            String encryptionKey, BoostLoggerI logger) throws IOException {
